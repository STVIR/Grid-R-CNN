...
from .. import builder
from mmdet.core import bbox2roi, bbox2result, build_assigner, build_sampler, random_jitter
...
class GridRCNN(TwoStageDetector):
    ...
    def forward_train(self,
        ...
        if self.with_grid:
            ...
            loss_grid = self.grid_head.loss(grid_pred1,grid_pred2,grid_targets)
    ...
    def simple_test(self, img, img_meta, proposals=None, rescale=False):
        ...
        if gridrois.shape[0] != 0:
            ...
            det_bboxes = self.grid_head.get_bboxes(det_bboxes, grid_pred, img_meta)
            if rescale:
